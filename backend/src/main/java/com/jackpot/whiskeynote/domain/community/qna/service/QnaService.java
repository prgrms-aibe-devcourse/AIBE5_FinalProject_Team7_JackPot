package com.jackpot.whiskeynote.domain.community.qna.service;
...
public class QnaService {
    ...
    public Page<PostSummaryResponse> getQnaPosts(int page, int size) {
        return postRepository
                .findByPostTypeAndIsDeletedFalseOrderByCreatedAtDesc(PostType.QA, PageRequest.of(page, size))
