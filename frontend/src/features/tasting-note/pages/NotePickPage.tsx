...
export default function NotePickPage() {
  ...
  return (
    <WireframePage>
      <p className="wf-breadcrumb">홈 / <strong>Note 작성</strong></p>

      <div className="wf-search-main wf-review-pick-main">
        <div className="wf-review-pick-intro">
          <h1 className="wf-search-result-comment">Note를 작성할 위스키를 선택하세요</h1>
          <p className="wf-review-pick-intro__hint">검색해서 원하는 보틀을 고르면 시음 노트 작성 화면으로 이동합니다.</p>
        </div>
